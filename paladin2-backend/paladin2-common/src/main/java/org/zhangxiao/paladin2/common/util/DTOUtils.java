...
import org.zhangxiao.paladin2.common.exception.error.CommonBizError;

public class DTOUtils {
    public static void checkThrow(BindingResult bindingResult) throws BizException {
        if (bindingResult.hasErrors() && bindingResult.getFieldError() != null) {
            throw new BizException(CommonBizError.DTO_INVALID.suffix(bindingResult.getFieldError().getDefaultMessage()));
        }
    }
}
